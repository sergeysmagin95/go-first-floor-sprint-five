...
func (w Walking) Calories() float64 {
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow((w.meanSpeed()/3.6), 2)/(w.Height/100))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
